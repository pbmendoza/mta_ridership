...
Purpose:
    Extracts unique combinations of STATION and LINENAME from the combined
    turnstile data and creates a station reference mapping.

Features:
    - Reads from combined turnstile data (data/local/staging/turnstile/turnstile_combined.csv)
    - Extracts STATION and LINENAME columns
    - Removes duplicate combinations while preserving those two columns
...
Usage:
    ...
    From scripts/one_off directory:
        python extract_unique_stations_turnstile.py

Output:
    references/stations/stations_turnstile.csv: Unique STATION/LINENAME combinations sorted
    by station name.
"""
